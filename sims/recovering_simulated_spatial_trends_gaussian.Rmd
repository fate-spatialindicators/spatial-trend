...
g2 = ggplot(sub, 
  ...
  ylab(" ") + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() 
g4 = ggplot(sub, 
  aes(phi, rho, group=phi)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(" ") + 
  ylab(" ") + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
...
f1 = ggplot(sub, 
  ...
  ylab(expression(paste("Bias E[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
f2 = ggplot(sub, 
  aes(sigma_E, sd, group=sigma_E)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatiotemporal ", sigma))) + 
  ylab(expression(paste("SD[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
f4 = ggplot(sub, 
  aes(sigma_E, rho, group=sigma_E)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatiotemporal ", sigma))) + 
  ylab(expression(paste("Correlation (", theta, ", ",hat(theta),")"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
...
h1 = ggplot(sub, 
  aes(sigma_O, bias, group=sigma_O)) + geom_hline(aes(yintercept=0),col="grey") + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial ", sigma))) + 
  ylab(expression(paste("Bias E[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
h2 = ggplot(sub, 
  aes(sigma_O, sd, group=sigma_O)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial ", sigma))) + 
  ylab(expression(paste("SD[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
h4 = ggplot(sub, 
  aes(sigma_O, rho, group=sigma_O)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial ", sigma))) + 
  ylab(expression(paste("Correlation (", theta, ", ",hat(theta),")"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
...
j1 = ggplot(sub, 
  aes(sigma_O_trend, bias, group=sigma_O_trend)) + geom_hline(aes(yintercept=0),col="grey") + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial trend ", sigma))) + 
  ylab(expression(paste("Bias E[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
j2 = ggplot(sub, 
  aes(sigma_O_trend, sd, group=sigma_O_trend)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial trend ", sigma))) + 
  ylab(expression(paste("SD[", theta, "-",hat(theta),"]"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
j4 = ggplot(sub, 
  aes(sigma_O_trend, rho, group=sigma_O_trend)) + geom_violin(fill=col,col=NA,alpha=0.5,width=0.3) + xlab(expression(paste("Spatial trend ", sigma))) + 
  ylab(expression(paste("Correlation (", theta, ", ",hat(theta),")"))) + stat_summary(fun=median, geom="point", size=2, color=col) + theme_sleek() + coord_flip()
